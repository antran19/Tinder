...
const LoginPage = () => {
    ...
    const googleLogin = useGoogleLogin({
        ...
        onError: () => setError('Lỗi kết nối tới Google. Vui lòng thử lại.')
    });
    ...
    const responseFacebook = async (response) => {
        ...
        try {
            setLoading(true);
            setError('');
            const res = await apiService.loginWithFacebook(response.accessToken);
            if (res.success) {
        ...
        <div className="login-page">
            ...
            <div className="login-container">
                ...
                <div className="login-card">
                    ...
                    <button type="button" className="social-login-btn google" onClick={() => googleLogin()}>
                    ...
                    <FacebookLogin
                        appId="1852256848816531"
                        autoLoad={false}
                        fields="name,picture"
                        scope="public_profile"
                        callback={responseFacebook}
                        render={renderProps => (
                            <button type="button" className="social-login-btn facebook" onClick={renderProps.onClick}>
